    ...
    return (
        <main>
            ...
            <div className='bg-gray-100 py-6 my-4'>
                <div className=' max-w-2xl mx-auto flex sm:max-w-4xl'>
                    <h1 className='border rounded-lg bg-customOrange flex items-center text-3xl font-extrabold text-gray-900 px-10'>
                        Donation Collected by {allCollectionDetails[0]?.collector_name.trim()}
                    </h1>
                </div>
            ...
            <div className='card my-10 '>
                <div className="grid grid-cols-2 gap-1 mx-2 sm:flex flex-col my-10  md:flex-row space-y-4 md:space-y-0 md:space-x-4 px-10">
                    <InfoCard keyvalue={0} title={"Total Donation"} info={cardData.total_donation} />
                    <InfoCard keyvalue={1} title={"Total Receipts"} info={cardData.total_receipts} />
                    <InfoCard keyvalue={2} title={"Total Donors"} info={cardData.total_donors} />
                    <InfoCard keyvalue={3} title={"Active Collectors"} info={cardData.total_collectors} />
                </div>
            </div>
